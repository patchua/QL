...
1) <work_spread value="3" /> - размер спреда, т.е. если спред больше данного значения то будем торговать

2) <wait_slippage value="15" /> - отступ от лучшей цены в глубь стакана, т.е. место где наши заявки будут "отсиживатся" в ожидании спреда

3) <clc value="56375" /> - код клиента

4) <account value="NL0011100043" /> - торговый счет

5) <alert_slippage value="20" /> - на сколько пунктов выше(ниже) от нашей цены входа должна пройти сделка, что бы мы активировали механизм экстренного выхода

6) <minprofit value="10" /> - тейк-профит
